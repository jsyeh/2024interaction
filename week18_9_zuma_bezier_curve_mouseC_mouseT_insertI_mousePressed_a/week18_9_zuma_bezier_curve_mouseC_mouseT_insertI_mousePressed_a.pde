// week18_9_zuma_bezier_curve_mouseC_mouseT_insertI_mousePressed_add
...
void setup(){
  ...
  C.add(new Integer(int(random(5))) );//C.append( int(random(5)) ); // 挑1個色彩
}
...
void draw(){
  ...
  mouseT = myNearestBezierT(mouseX, mouseY, p0, p1, p2, p3);
